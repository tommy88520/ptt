  ...
  return (
    <footer className="border-t border-gray-200 py-6 dark:border-gray-800">
      <div className="mx-auto flex max-w-2xl flex-col items-center gap-3 px-4">
        <a
          href="https://ko-fi.com/tommy88520"
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-1.5 rounded-full bg-amber-500 px-4 py-1.5 text-xs font-medium text-white hover:bg-amber-600"
        >
          ☕ 請我喝杯咖啡
        </a>
